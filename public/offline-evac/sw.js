/* global self, caches */
const CACHE = 'jishingoto-offline-shell-v36';
const SHELL = ['index.html','style.css','app.mjs','map.mjs','core.mjs','routing.mjs','report.mjs','vector.mjs','vendor/maplibre-gl.mjs','vendor/maplibre-gl-shared.mjs','vendor/maplibre-gl-worker.mjs','vendor/maplibre-gl.css','storage.mjs','expiry.mjs','shelters.mjs','places.mjs','registration.mjs','entry.mjs','manifest.webmanifest','icon.svg','/brand/symbol-v6.png'].map(p => new URL(p, self.registration.scope).href);

...
export type SafetyProduct = {
  ...
  easyReason: string;
  query: string;
  examples?: { amazonUrl: string; searchQuery: string; name: string; specification: string; check: string; url: string }[];
  riskNames: string[];
...
const RULES: ProductRule[] = [
  {
    ...
    examples: [
      { amazonUrl: "https://www.amazon.co.jp/dp/B07W1JQQC5", searchQuery: "エレコム TS-F001", name: "エレコム TS-F001（L型・2個入り）", specification: "家具と壁に貼り付けるタイプ。耐荷重115kg（2個使用時）。", check: "収納物を含む重量、壁材の適合、壁との隙間を確認。凹凸面や一部の特殊な壁紙には使えません。", url: "https://www.elecom.co.jp/products/TS-F001.html" },
      { amazonUrl: "https://www.amazon.co.jp/dp/B0DF75BK4N", searchQuery: "アイリスオーヤマ KTB-30R", name: "アイリスオーヤマ KTB-30R（Sサイズ・2本入り）", specification: "家具上部と天井の間が30〜40cmの場合の候補。", check: "隙間を実測し、天井と家具の強度・設置位置を説明書で確認。ポール式はストッパー式などとの併用も検討します。", url: "https://www.irisohyama.co.jp/products/tool-diy-material/emergency-supplies/earthquake-preparedness-products/furniture-fall-prevention-rod-prop-type" },
    ],
    kind: "fall",
  ...
  },
  {
    ...
    objectTypes: ["tv"],
    examples: [
      { amazonUrl: "https://www.amazon.co.jp/dp/B079VX74FP", searchQuery: "エレコム TS-001N2", name: "エレコム TS-001N2（粘着シールタイプ）", specification: "40V型までのテレビ向け耐震ベルト。", check: "対応サイズ・貼付面・固定位置を確認してください。", url: "https://www.elecom.co.jp/products/TS-001N2.html" },
    ],
    kind: "fall",
  },
  {
  ...
  },
  {
    ...
    objectTypes: ["window"],
    examples: [
      { amazonUrl: "https://www.amazon.co.jp/dp/B001NA0E2K", searchQuery: "ニトムズ M6120", name: "ニトムズ M6120 ガラス飛散防止シート", specification: "幅48cm × 長さ1.8m・1枚入り。広幅M6330は幅96cm。", check: "ガラスの寸法・種類を確認。凹凸面は専用のM6070などを比較し、網入り・複層ガラス等への適合はメーカーに確認します。", url: "https://www.nitoms.com/products/glass_shatterproof_sheet/" },
    ],
    kind: "break",
    fallbackForKind: false,
  },
  {
    ...
    examples: [{ amazonUrl: "https://www.amazon.co.jp/dp/B0011EZ7U2", searchQuery: "ニトムズ M6130", name: "ニトムズ M6130 食器棚用ガラス飛散防止シート", specification: "幅32cm × 長さ1.8m・1枚入り。", check: "ガラス扉がある場合だけ検討。扉の寸法、ガラスの種類、貼付面を確認してください。", url: "https://www.nitoms.com/products/glass_shatterproof_sheet/" }],
  },
  {
    id: "hanging-wire",
    name: "落下防止ワイヤー",

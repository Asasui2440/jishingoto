...
export async function createAftermathShareFile(url: string, mock = false): Promise<File> {
  ...
  context.fillText(mock ? "サンプルの予想図 · あなたの部屋の再現ではありません" : "AIによる予想図 · 実際の被害写真ではありません", width / 2, height + footer * 0.44);

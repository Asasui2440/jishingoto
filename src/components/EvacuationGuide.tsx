...
export function EvacuationGuide() {
  return <section className="space-y-3 rounded-panel bg-secondary-soft p-4">
    ...
    <div>
      <Image src="/illustrations/actions/school-evacuation-v11.png" alt="ヘルメットを着用した親子が、真剣な表情で近所の小学校の避難所へ向かう様子" width={1536} height={1024} className="mx-auto h-auto max-h-56 w-auto max-w-[88%] rounded-field object-contain" />
      ...
      <Image src="/illustrations/actions/coast-evacuate-v20.png" alt="防災用のバッグを持ち、海から離れて高台へ急いで避難する親子" width={1536} height={1024} className="mx-auto mt-4 h-auto max-h-56 w-auto max-w-[88%] rounded-field object-contain" />

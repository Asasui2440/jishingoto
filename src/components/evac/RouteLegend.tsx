...
export function RouteLegend() {
  return (
    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-11 text-ink-muted" aria-label="地図の凡例">
      ...
      <span className="flex items-center gap-1.5"><i className="grid size-4 place-items-center rounded-full bg-primary text-[0.625rem] font-bold not-italic text-ink">1</i><Furigana text="判断[はんだん]ポイント" /></span>
    </div>
  );
}

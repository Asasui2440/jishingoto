...
test("adult quizzes keep five room-linked questions while adding four meaningful choices and review clues", async () => {
  ...
  for (const id of ["under-desk", "curtain", "move-away", "protect-head", "clear-exit", "open-exit", "check-family", "kitchen-check", "shelter-home-0", "shelter-damaged-0"]) assert(seen.has(id), id);
